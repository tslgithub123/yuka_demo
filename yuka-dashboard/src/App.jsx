...
function App() {
  ...
  // Format T_Tot like "00955:43:00" → "955:43:00" (remove leading zeros in hours)
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="rounded-2xl bg-gradient-to-br from-red-50 to-orange-50 border border-red-200 p-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="text-sm text-gray-600">
                          Temperature: {inlet?.temp?.toFixed(1) || "--"}°C • Humidity: {inlet?.hum?.toFixed(0) || "--"}%
                        </div>
                        {/* <div className="text-xs text-gray-500 flex items-center gap-2">
                          <Clock className="w-4 h-4" />
                          Running Time: {inlet ? formatRunningTime(inlet.T_Tot) : "--"}
                        </div>
                        <div className="text-xs text-gray-500">
                          Volume Processed: {inlet ? formatVolume(inlet.V_Tot) : "--"}
                        </div> */}
                      </div>
                    </div>
                    {/* Outlet */}
                    <div className="rounded-2xl bg-gradient-to-br from-emerald-50 to-cyan-50 border border-green-200 p-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="text-sm text-gray-600">
                          Temperature: {outlet?.temp?.toFixed(1) || "--"}°C • Humidity: {outlet?.hum?.toFixed(0) || "--"}%
                        </div>
                        <div className="text-xs text-gray-500 flex items-center gap-2">
                          <Clock className="w-4 h-4" />
